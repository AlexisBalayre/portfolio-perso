<template>
  <div class="bg-[#09162E] grid min-w-screen h-full min-h-screen max-w-screen overflow-x-hidden">
    <!--==========================================
                  HEADER
    ===========================================-->
    <div class="grid-flow-col grid lg:pb-5 w-screen h-fit md:pt-8 pb-4 md:pl-8 md:pr-8 pt-4 pl-4 pr-4" >
      ...
      <div class="justify-self-end flex">
        ...
        <!-- Github -->
        <a class="lg:pl-4 lg:pr-4 lg-2 pr-2" href="https://github.com/AlexisBal" target="_blank">
          <svg 
            xmlns="http://www.w3.org/2000/svg" 
            viewBox="0 0 496 512" 
            class="w-8 h-8"
         ...
         <!-- Linkedin -->
         <a class="lg:pl-4 lg:pr-4 lg-2 pr-2" href="https://fr.linkedin.com/in/alexis-balayre" target="_blank">
          <svg
            class="w-8 h-8"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
    ...
    <!--==========================================
                  ABOUT ME
    ===========================================-->
    <div class="ring-offset-white ring-offset-1/2 ring-white/20 ring-1 bg-indigo-200/10 grid p-6 md:pl-8 md:pr-8 mr-8 ml-8 md:ml-20 md:mr-20 mt-5 md:mt-10 md:mt-4 rounded-xl md:w-1/2 justify-self-center md:mt-20 mb-16">
      ...
      <div class="justify-self-center mt-6">
        <p class="text-lg text-left md:text-justify self-center text-white">My name is Alexis Balayre and I am a French <a class=" text-lg font-bold">full-stack developer</a> specialized in <a class="text-lg font-bold">Web3</a>. I realize all the missions related to the creation of a <a class=" text-lg  font-bold">decentralized application (DApp)</a> from <a class=" text-lg  font-bold">smart contracts</a> to the <a class=" text-lg  font-bold">user interface</a>.</p>
      </div>
    </div>
    ...
    <!--==========================================
                  TECHNOLOGIES
    ===========================================-->
    <div class="ring-offset-white ring-offset-1/2 ring-white/20 ring-1 bg-indigo-200/10 h-fit w-screen max-w-screen p-6 flex overflow-hidden md:mt-16 mt-10">
    ...
    <!--==========================================
                  FREE NFT
    ===========================================-->
    <div class="ring-offset-white ring-offset-1/2 ring-white/20 ring-1 bg-indigo-200/10 grid md:mt-20 mt-10 ml-8 mr-8 mb-5 md:mb-10 p-6 md:p-8 lg:w-3/6 h-fit rounded-xl justify-self-center">
      ...
      <p class=" text-lg mt-4 font-medium text-left text-white">Enter your Ethereum wallet address</p>
      <p class=" text-lg font-medium text-left text-red-500 hidden" id="error">An error has occurred, please check your address!</p>
      <p class=" text-lg font-medium text-left text-green-500 hidden" id="success">Successful transaction: See on <a id="link" class="underline decoration-sky-500 font-bold">polygonscan</a></p>
...
export default defineNuxtComponent({
  ...
  data: () => ({
      ...
      formation: [
        {
          logo: "isep.png",
          title: 'ISEP - Engineering Master Degree',
        ...
        {
          logo: 'isep.png',
          title: 'ISEP - International Integrated Cycle',
